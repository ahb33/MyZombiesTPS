...
AProjectile::AProjectile()
{
    ...
    CollisionSphere->SetCollisionResponseToChannel(ECC_PhysicsBody, ECollisionResponse::ECR_Block);
    CollisionSphere->SetNotifyRigidBodyCollision(true); // Enable hit events
